...
test('renders hash-verified offline v7 gates without presenting v7 as runtime', async () => {
  vi.mocked(fetchV7Status).mockResolvedValueOnce({
    ...
    evidence_boundaries: { MaleCNS_Tm4_synapse_count_right_hex_distance_counts: { '0': 28, '1': 5, '2': 14, '3': 1 }, MaleCNS_Tm4_synapse_count_right_within_one_hex_fraction: 33 / 48, MaleCNS_Tm4_synapse_count_left_distinct_candidate_count: 48, MaleCNS_Tm4_post_hoc_hex_tolerance_authorized: false, MaleCNS_Tm4_native_count_by_side: { L: 0, R: 833 }, MaleCNS_Tm4_synapse_count_right_exact_fraction: 28 / 48, MaleCNS_Tm4_synapse_count_left_unique_candidate_fraction: 1, MaleCNS_Tm4_synapse_count_candidate_native_equivalent: false, MaleCNS_Tm4_left_coordinate_writeback_authorized: false, MaleCNS_Tm3_same_type_native_coordinate_validation_available: false, MaleCNS_Tm4_one_hop_blind_replay_rounded_exact_fraction: 0.31932773109243695, MaleCNS_one_hop_coordinates_native_equivalent: false, MaleCNS_coordinate_rule_as_experimental_mapping_authorized: false, nine_source_contract_complete: false, Mi4_C3_direct_numeric_voltage_candidates: ['Groschner_2022'], Mi4_C3_independent_numeric_voltage_candidate_count: 0, T5_voltage_field_counts: { aggregated_full_field_OFF_flash: 7, raw_white_noise: 8, raw_drifting_grating: 9 }, T5_voltage_derived_kernel_sources: ['Tm1', 'Tm2', 'Tm4', 'Tm9'], T5_voltage_derived_kernel_record_count: 25, T5_kernel_sample_interval_seconds: 0.01, T5_raw_kernel_gain_transferable: false, T5_kernel_stimulus_invariant: false, T5_source_kernel_transfer_authorized: false, T5_four_Tm_exact_type_average_mapping_complete: true, T5_all_five_source_mapping_complete: false, T5_CT1_mapping_Lo1_column_count_by_body: { '10009': 868, '10157': 802 }, Braun_calcium_fly_counts: { Tm2: 9, Tm9: 11, CT1: 9 }, Braun_calcium_condition_grids_complete: true, Braun_calcium_allowed_voltage_sources: [], Gou_Dryad_archive_hash_locally_verified: true, Gou_Dryad_local_processed_calcium_sources: ['Mi1', 'Tm3', 'Tm1', 'Tm2'], Gou_Dryad_flash_fly_axis_sizes: { Mi1: 16, Tm3: 11, Tm1: 9, Tm2: 8 }, Gou_Dryad_moving_bar_fly_axis_sizes: { Mi1: 10, Tm3: 6, Tm1: 8, Tm2: 12 }, Gou_Dryad_Mi1_Tm3_direction_axis_identifiable: false, Gou_Dryad_direction_invariance_evaluated: false, Gou_DANDI_all_assets_stimulus_metadata_indexed: true, Gou_DANDI_Mi1_Tm3_asset_counts: { Mi1: 144, Tm3: 20 }, Gou_DANDI_Mi1_Tm3_stimulus_metadata_available: false, Gou_Dryad_stable_biological_individual_IDs_verified: false, Gou_DANDI_asset_level_stable_participant_IDs_verified: true, Gou_DANDI_unique_subject_ID_count: 282, Gou_Dryad_distinct_fliesUsed_label_count: 66, Gou_Dryad_DANDI_identity_crosswalk_match_count: 0, Gou_Dryad_rows_to_DANDI_subject_crosswalk_verified: false, Gou_Dryad_experimental_membrane_voltage: false, v7_offline_time_coordinate_contract_complete: true, v7_offline_horizontal_coordinate_contract_complete: true, v7_offline_two_dimensional_angular_calibration_complete: false, v7_vertical_camera_ray_angles_declared: false, v7_vertical_FOV_declared: false, v7_vertical_pixel_to_angle_formula_declared: false, v7_vertical_motion_has_physical_angular_units: false, v7_looming_radius_has_physical_angular_units: false, v7_retinal_v_has_physical_angular_units: false, v7_offline_2D_engineering_angular_grid_complete: true, v7_offline_engineering_vertical_FOV_degrees: 70.09590046813251, v7_offline_engineering_angular_pixel_pitch_degrees: 3.047647846440544, v7_offline_engineering_grid_biologically_calibrated: false, v7_offline_frame_interval_milliseconds: 10, v7_offline_substep_interval_milliseconds: 2.5, v7_horizontal_fov_degrees: 143.2394487827058, T4_source_mapping_mode: 'exact_type_average', T4_source_recording_level_body_assignment: false, T4_exact_type_average_mapping_complete: true, T4_author_minmax_formula_reproduced: true, T4_state_mapping_held_out_outside_fraction_by_source: { Mi1: 0.1295625, Tm3: 0.17478125, Mi4: 0.2870446428571429, C3: 0.18847916666666667 }, T4_author_minmax_semantics_match_v7_state: false, T4_millivolts_to_v7_state_mapping_available: false, T5_record_specific_stimulus_logs_available: false, Motyxia2_public_history_branch_count: 22, Motyxia2_public_history_commit_count: 447, T5_record_log_found_in_Motyxia2_public_history: false, T5_external_successful_indexes_linked_log_found: false, T5_PMC_supplement_content_inspected: false, T5_publisher_supplements_inspected: true, T5_publisher_supplements_contain_record_log: false, T5_Figshare_search_accessible: false, T5_stimulus_log_global_absence_claimed: false, T5_generator_defaults_used_as_record_fields: false, T5_stimulus_provenance_complete: false, T5_Figure4_relative_PD_ND_mapping_verified: true, T5_Figure4_native_coordinate_motion_mapping_verified: true, T5_Figure4_absolute_physical_direction_mapping_verified: false, T5_Kohn_Portes_record_level_direction_code_available: false, T5_Kohn_Portes_record_level_physical_direction_available: false, T5_cross_dataset_direction_mapping_authorized: false, CT1_audited_candidate_count: 11, CT1_incremental_2025_2026_candidate_count: 3, CT1_direct_experimental_voltage_candidate_found: false, CT1_PuRe_archive_contents_verified: true, CT1_PuRe_new_numerical_payload_verified: false, Tm9_official_synapse_coordinate: [15, 2], CT1_per_synapse_Lo1_columnar_retinotopy_available: true, CT1_complete_official_LO_column_coverage: false },
  ...
  expect(screen.getByText(/MaleCNS one-hop 坐标盲重放：Tm3 同型 native 参考不存在；Tm4 rounded-exact 31.9%/)).toBeInTheDocument()
  expect(screen.getByText('MaleCNS Tm4 官方 synapse-count 样本：native hex 左/右 0/833；右侧 48 个 native 样本 exact 58.3%，距 native 0/1/2/3 列为 28/5/14/1；左侧 48 个缺失样本唯一且互异候选 48。候选不可视为 native，距离容差未授权，左侧写回未授权。')).toBeInTheDocument()
  ...
  expect(screen.getByText(/Gou Fig.6 方向轴：Mi1\/Tm3 逐记录标签不可识别；方向不变性检验未执行/)).toBeInTheDocument()
  expect(screen.getByText(/Gou DANDI NWB：282\/282 已索引；Mi1\/Tm3 assets 144\/20；stimulus\/interval metadata 未保留/)).toBeInTheDocument()
  expect(screen.getByText(/T5 方向码：Figure 4 的 0→ND \/ 1→PD 已验证；0\/1 到原生感受野坐标递减\/递增可追踪/)).toBeInTheDocument()
  expect(screen.getByText(/T5 source kernel：Kohn–Portes Tm1\/Tm2\/Tm4\/Tm9 共 25 条 whole-cell white-noise 记录，核步长 10 ms/)).toBeInTheDocument()
  expect(screen.getByText(/T5 source→MaleCNS：Tm1\/Tm2\/Tm4\/Tm9 exact-type-average 完整；五源总体不完整/)).toBeInTheDocument()
