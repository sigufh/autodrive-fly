...
test('renders hash-verified offline v7 gates without presenting v7 as runtime', async () => {
  ...
  expect(screen.getByText('MaleCNS Tm4 官方 synapse-count 样本：native hex 左/右 0/833；右侧 48 个 native 样本 exact 58.3%，左侧 48 个缺失样本唯一候选 100.0%。候选不可视为 native，左侧写回未授权。')).toBeInTheDocument()
